...
export async function GET(req: NextRequest) {
  try {
    ...
    const query = 'SELECT * FROM Invoice ORDERBY MetaData.CreateTime DESC MAXRESULTS 50';
    ...
    console.error('Failed to fetch invoices:', error?.authResponse?.getJson?.() || error.message);
